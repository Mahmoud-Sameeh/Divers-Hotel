...
namespace Divers_Hotel.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName,Descrption,Price")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName,Descrption,Price")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
